...
par.segments_length = 15;             % length (in minutes) of segments in which the data is cutted (default 5min). 
...
par.max_spikes_plot = 100000;          % max. number of spikes to be plotted 
...
par.min_clus = 100; %20                % minimum size of a cluster (default 60) 
...
par.stdmin = 5.5;%5;                      % minimum threshold for detection 
 
par.stdmax = 50;                     % maximum threshold for detection 
 
par.detect_fmin = 300;               % high pass filter for detection 
 
par.detect_fmax = 5000;              % low pass filter for detection (default 1000) 
